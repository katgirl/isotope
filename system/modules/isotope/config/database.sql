...
CREATE TABLE `tl_iso_products` (
  ...
  `lidcolor` blob NULL,
  `cupsize` blob NULL,
  `dualessystem` blob NULL,
  `cupdesign` blob NULL,
  `setup` blob NULL,
  `cupmaterial` blob NULL,
  `readyforshipment` varchar(255) NOT NULL default '',
  `taxshipping` varchar(255) NOT NULL default '',
  `zeroshippingcosts` varchar(255) NOT NULL default '',
  `digitalproof` blob NULL,
  `druck` blob NULL,
  `free_run` varchar(255) NOT NULL default '',
  `tabs180` text NULL,
  ...
  `price_cupmaterial` varchar(255) NOT NULL default '',
  `price_duales_system` varchar(255) NOT NULL default '',
  `setup_clearcup` blob NULL,
  `print_clearcup` blob NULL,
  `information` text NULL,
  `lidsize` blob NULL,
  `product_teaser` varchar(255) NOT NULL default '',
  `free_cupsize` blob NULL,
  `free_dualessystem` blob NULL,
  `free_cupdesign` blob NULL,
  `free_setup` blob NULL,
  `free_setup_clearcups` blob NULL,
  `free_cupmaterial` blob NULL,
  `free_proof` blob NULL,
  `free_print_clearcup` blob NULL,
  `delivery` blob NULL,
  `price_bio_cupmaterial_shine` varchar(255) NOT NULL default '',
  `price_bio_cupmaterial_shine__avaopts` blob NULL,
  `price_cupmaterial_shine` varchar(255) NOT NULL default '',
  `price_cupmaterial_shine__avaopts` blob NULL,
  `price_cupmaterial_matt` varchar(255) NOT NULL default '',
  `price_cupmaterial_matt__avaopts` blob NULL,
  `cup_refinement` blob NULL,
  `cup_refinement__avaopts` blob NULL,
  `setup_premiumcup` blob NULL,
  `setup_premiumcup__avaopts` blob NULL,
  `delivery_time` blob NULL,
  `delivery_time__avaopts` blob NULL,
  `free_delivery_time` blob NULL,
  `free_delivery_time__avaopts` blob NULL,
  `tabs_1800` text NULL,
  `tabs_1800__avaopts` blob NULL,
  `tabs_2400` text NULL,
  `tabs_2400__avaopts` blob NULL,
  `tabs_3700` text NULL,
  `tabs_3700__avaopts` blob NULL,
  `tabs_5000` text NULL,
  `tabs_5000__avaopts` blob NULL,
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
